...
if (isNil ("RydHQF_AmmoBoxes")) then 
	...
	if !(isNil "RydHQF_AmmoDepot") then 
		{
...
while {true} do
	...
	if (isNil ("RydHQF_RCASB")) then {RydHQF_RCAS = []};
	_HQ setVariable ["RydHQ_RCAS",RydHQF_RCAS];
	if (isNil ("RydHQF_RCAPB")) then {RydHQF_RCAP = []};
	...
	if (isNil "RydHQF_Obj1") then {RydHQF_Obj1 = createTrigger ["EmptyDetector", leaderHQB]};
	if (isNil "RydHQF_Obj2") then {RydHQF_Obj2 = createTrigger ["EmptyDetector", leaderHQB]};
	if (isNil "RydHQF_Obj3") then {RydHQF_Obj3 = createTrigger ["EmptyDetector", leaderHQB]};
	if (isNil "RydHQF_Obj4") then {RydHQF_Obj4 = createTrigger ["EmptyDetector", leaderHQB]};
