...
if (isNil ("RydHQD_AmmoBoxes")) then 
	...
	if !(isNil "RydHQD_AmmoDepot") then 
		{
...
while {true} do
	...
	if (isNil ("RydHQD_RCASB")) then {RydHQD_RCAS = []};
	_HQ setVariable ["RydHQ_RCAS",RydHQD_RCAS];
	if (isNil ("RydHQD_RCAPB")) then {RydHQD_RCAP = []};
	...
	if (isNil "RydHQD_Obj1") then {RydHQD_Obj1 = createTrigger ["EmptyDetector", leaderHQB]};
	if (isNil "RydHQD_Obj2") then {RydHQD_Obj2 = createTrigger ["EmptyDetector", leaderHQB]};
	if (isNil "RydHQD_Obj3") then {RydHQD_Obj3 = createTrigger ["EmptyDetector", leaderHQB]};
	if (isNil "RydHQD_Obj4") then {RydHQD_Obj4 = createTrigger ["EmptyDetector", leaderHQB]};
