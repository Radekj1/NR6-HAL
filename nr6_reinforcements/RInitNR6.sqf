...
SpawnRGroup = {
    ...
    private ["_grp","_vharr","_class","_crewGear","_unit","_SelGroup","_grpi","_selectedPos","_sentence","_pylons"];
	params ["_SpawnPos","_SpawnRadius","_side","_Pool","_Leaders","_RejoinPoint","_ExtraArgs"];
...
NR6_GetUnit = {
	...
	*/
	...
	if ((count _nearObjs) > 0) then {
		private _nearObjs = [_nearObjs, [], {_objPos distance _x }, "ASCEND",{true}] call BIS_fnc_sortBy;
