...
private 
    [
    "_side","_flight","_Commanders","_coreObj","_SpawnPads","_StartForces","_sidetick","_faction","_CurrentForces","_Pool","_Threshold","_Leaders","_SpawnRGroup","_CTR","_grp", "_GoodPads","_LiveForces","_CLiveForces","_CStartForces","_TickTime","_ExtraArgs","_sidetickHold","_sideEn","_sideEn2","_SpawnPos","_playerRange"
    ];
