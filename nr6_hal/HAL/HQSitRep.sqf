private [
    ...
    "_civF","_specFor_class", "_recon_class", "_FO_class", "_snipers_class",
    ...
    "_Other_class", "_NCrewInf_class","_SpecFor", "_SpecForG", "_recon",
	"_reconG", "_FO", "_FOG","_snipers", "_snipersG", "_ATinf", "_ATinfG",
	"_AAinf", "_AAinfG","_Inf", "_InfG", "_Art", "_ArtG", "_HArmor", "_HArmorG",
...
while {true} do
	{
	diag_log text "HQSitRep A: Loop started";
	...
	diag_log text "HQSitRep A: Step 1";
	...
	diag_log text "HQSitRep A: Step 3";
	...
	_HQ setVariable ["RydHQ_Front",RydHQ_Front];
	...
	if (isNil ("RydHQ_GarrLim")) then {RydHQ_GarrLim = 5};
	_HQ setVariable ["RydHQ_GarrLim",RydHQ_GarrLim];
	...
	diag_log text "HQSitRep A: Step 4";
	...
	diag_log text "HQSitRep A: Step 5";
	...
	diag_log text "HQSitRep A: Step 6";
	...
	diag_log text "HQSitRep A: Step 7";
	...
	diag_log text "HQSitRep A: Step 8";
	switch (_nObj) do
		{
